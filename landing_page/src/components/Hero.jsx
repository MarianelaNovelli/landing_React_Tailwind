...
const Hero = () => {
  return (
    <section className='min-h-[90vh] grid grid-cols-1 xl:grid-cols-8'>
        {/* Titulo - Presentacion - Botones */}
        <div className='md:col-span-5 flex items-center justify-center p-8 xl:p-16'>
            <div className='flex flex-col gap-8'>
                <h1 className='text-5xl text-secondary xl:text-6xl font-bold leading-[5rem] xl:leading-[7.5rem]'>Mi Landing Page con <span className='text-primary py-2 px-4 border-8 border-primary relative inline-block'>React</span></h1>
